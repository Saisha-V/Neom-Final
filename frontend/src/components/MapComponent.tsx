...
const MapComponent = () => {
  ...
  const markers = [
    { position: [28.7041, 77.1025], popup: "New Delhi" },
    { position: [19.076, 72.8777], popup: "Mumbai" },
    { position: [13.0827, 80.2707], popup: "Chennai" },
    { position: [12.9716, 77.5946], popup: "Bengaluru" },
    { position: [22.5726, 88.3639], popup: "Kolkata" },
    { position: [26.9124, 75.7873], popup: "Jaipur" },
  ];
  ...
  return (
    <>
      ...
      <div className="px-40 pb-20 bg-[#F9F7F2]">
        <div style={{ zIndex: 49, position: "relative" }}>
          <MapContainer
